...
export const SITE_CONFIG = {
  ...
  audio: {
    // Placeholder ambient loop path. Drop a file at /public/audio/ambience.mp3
    // to enable. When the source is missing the player still renders but
    // shows a graceful "not configured" state.
    ambientSrc: '/audio/ambience.mp3',
    defaultVolume: 0.35,
    label: 'Torchlit Ambience',
  },
};
...
export const DISCORD_URL = SITE_CONFIG.social.discord;
