...
export const SITE_CONFIG = {
  ...
  social: {
    discord:   'https://discord.gg/8tsJ3cG5zQ',
 ...
 * used in SEO metadata, robots.txt, and sitemap.xml.
 *
 * We intentionally do NOT read NEXT_PUBLIC_BASE_URL / VERCEL_URL here: those
 * resolve to the *.vercel.app deployment domain, which must never appear as a
 * canonical/Host/Sitemap URL. Search engines should always be pointed at the
 * production domain.
 */
export const SITE_URL = 'https://ratattacktcg.com';
